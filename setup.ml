...
(* OASIS_START *)
(* DO NOT EDIT (digest: c8e5df7ebdde7e3059dd613f0f1c3858) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["David Sheets"; "Hugo Heuzard"];
          homepage = None;
          synopsis =
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_byteopt =
                        [(OASISExpr.EBool true, ["-w"; "@f@p@u@s@40"])];
                      bs_nativeopt =
                        [(OASISExpr.EBool true, ["-w"; "@f@p@u@s@40"])]
                   },
                   {
                      lib_modules = ["Ipaddr"; "Macaddr"];
                      lib_pack = false;
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_command = [(OASISExpr.EBool true, ("make", []))];
                      test_custom =
                        {
                           pre_command = [(OASISExpr.EBool true, None)];
                           post_command = [(OASISExpr.EBool true, None)]
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\218\015@\198;\130u\225w\204\148\211\203\239k\185";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
