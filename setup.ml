...
(* OASIS_START *)
(* DO NOT EDIT (digest: b24b28e1709be4cf4d1a3fb33bee0c11) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_byteopt = [(OASISExpr.EBool true, ["-w"; "@f@p@u"])];
                      bs_nativeopt =
                        [(OASISExpr.EBool true, ["-w"; "@f@p@u"])];
                      },
                   {
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some " \027\195\229%\003\233\019\153)\136\138pH\227\198";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
